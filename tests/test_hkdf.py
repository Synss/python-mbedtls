...
class TestHKDF:
    ...
    def test_hkdf_with_options(
        self, key, salt, info, hmac, length
    ):
...
class TestHKDF_RFC5869_TestVectors:
    def test_case_1(self):
        ...
        length = 42
        prk = to_bytes(
            int("0x077709362c2e32df0ddc3f0dc47bba63"
                "90b6c73bb50f9c3122ec844ad7c2b3e5", 0),
            32
        )
        okm = to_bytes(
            int("0x3cb25f25faacd57a90434f64d0362f2a"
    ...
    def test_case_2(self):
        algorithm = _hmac.sha256
        ikm = to_bytes(
            int("0x000102030405060708090a0b0c0d0e0f"
                "101112131415161718191a1b1c1d1e1f"
                "202122232425262728292a2b2c2d2e2f"
                "303132333435363738393a3b3c3d3e3f"
                "404142434445464748494a4b4c4d4e4f", 0),
            80
        )
        salt = to_bytes(
            int("0x606162636465666768696a6b6c6d6e6f"
                "707172737475767778797a7b7c7d7e7f"
                "808182838485868788898a8b8c8d8e8f"
                "909192939495969798999a9b9c9d9e9f"
                "a0a1a2a3a4a5a6a7a8a9aaabacadaeaf", 0),
            80)
        info = to_bytes(
            int("0xb0b1b2b3b4b5b6b7b8b9babbbcbdbebf"
        ...
        length = 82
        prk = to_bytes(
            int("0x06a6b88c5853361a06104c9ceb35b45c"
                "ef760014904671014a193f40c15fc244", 0),
            32)
        okm = to_bytes(
            int("0xb11e398dc80327a1c8e7f78c596a4934"
    ...
    def test_case_3(self):
        ...
        length = 42
        prk = to_bytes(
            int("0x19ef24a32c717b167f33a91d6f648bdf"
                "96596776afdb6377ac434c1c293ccb04", 0),
            32)
        okm = to_bytes(
            int("0x8da4e775a563c18f715f802a063c5a31"
                "b8a11f5c5ee1879ec3454e5f3c738d2d"
                "9d201395faa4b61a96c8", 0),
            42)
    ...
    def test_case_4(self):
        ...
        okm = to_bytes(
            int("0x085a01ea1b10f36933068b56efa5ad81"
                "a4f14b822f5b091568a9cdd4f155fda2"
                "c22e422478d305f3f896", 0),
            42)
    ...
    def test_case_5(self):
        ...
        okm = to_bytes(
            int("0x0bd770a74d1160f7c9f12cd5912a06eb"
    ...
    def test_case_6(self):
        ...
        okm = to_bytes(
            int("0x0ac1af7002b3d761d1e55298da9d0506"
                "b9ae52057220a306e07b6b87e8df21d0"
                "ea00033de03984d34918", 0),
            42)
    ...
    def test_case_7(self):
        ...
        okm = to_bytes(
            int("0x2c91117204d745f3500d636a62f64f0a"
                "b3bae548aa53d423b0d1f27ebba6f5e5"
                "673a081d70cce7acfc48", 0),
            42)
